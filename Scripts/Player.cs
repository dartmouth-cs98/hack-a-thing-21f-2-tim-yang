...
namespace TextRPG
{
	public class Player : TextRPG.Character
	{
		...
		public void Move(int direction)
		{
			...
			{
				Journal.Instance.Log("You are at the edge of the map!");
			}
		}
		...
		public void Investigate()
		{
			...
			{
				Journal.Instance.Log("You're jumped by a " + Room.Enemy.Description + "! What would you do? Fight, or flee?");
