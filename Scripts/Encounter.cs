...
namespace TextRPG
{
	public class Encounter : MonoBehaviour
	{
		...
		public void OpenChest()
		{
			...
			{
				player.TakeDamage(-7);
				Journal.Instance.Log("It contained a healing spell! You've gained 7 energy.");
			}
			else if (chest.Enemy)
			{
		...
		public void Flee()
		{
			...
			Journal.Instance.Log("<color=#59ffa1>The enemy attacked you as you flee, dealing <b>" + enemyDamageAmount + "</b> damage!</color>");
			player.Investigate();
		}
		...
		public void Loot()
		{
			...
			Journal.Instance.Log(string.Format(
				"<color=#56FFC7FF>You've slain {0}. Searching its carcass, you find a {1} and {2} gold!</color>",
